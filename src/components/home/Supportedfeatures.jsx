  ...
  return (
    <div className='text-white pt-[30px] md:pt-[60px] lg:pt-[100px] pb-[80px]'>
        ...
        <div className='px-3 sm:px-7 xl:px-14 flex flex-col items-center lg:flex-row justify-between text-[20px] text-center sm:text-left'>
            <section className='w-full sm:w-[450px] lg:w-[32%] h-[516.8px] bg-[rgba(105,206,209,0.11)] sm:px-7 px-3 flex flex-col justify-center lg:justify-end pb-[4%] lg:pb-[4px] xl:pb-[4%] rounded-[28px] pt-3 lg:pt-0'>
                <h1 className='text-[#69CED1] text-[30px] lg:text-[32px] xl:text-[40px] mb-2 sm:mb-1 lg:mb-4 xl:mb-7'>The Ultimate DeFi Powerhouse</h1>
            ...
            <section className='w-full sm:w-[450px] lg:w-[32%] justify-center h-[516.8px] bg-[#69CED1] sm:px-7 px-3 flex flex-col lg:justify-end pb-[8%] rounded-[28px] mt-8 lg:mt-[-60px] pt-2 lg:pt-7'>
                <h1 className='text-[#000000] text-[30px] lg:text-[32px] xl:text-[40px] mb-4 sm:mb-7'>User Centric Interface</h1>
            ...
            <section className='w-full sm:w-[450px] lg:w-[32%] justify-center h-[516.8px] bg-[rgba(105,206,209,0.11)] sm:px-7 px-3 flex flex-col lg:justify-end pb-[4%] rounded-[28px] mt-8 lg:mt-0 pt-7 lg:pt-0'>
                <h1 className='text-[#69CED1] text-[30px] lg:text-[32px] xl:text-[40px] mb-4 sm:mb-7'>Sustainable Growth</h1>
