...
function Navbar() {
  ...
  return (
    <nav className='flex items-center justify-between h-[80px] px-6 lg:px-10 fixed top-0 w-full z-[999] bg-[#1E1E1E]'>
        ...
        <ul className={`w-full lg:w-[35%] flex justify-between text-white lg:text-[14px] fixed lg:static lg:flex-row flex-col top-[80px] ${toggleMobileNav ? 'right-[-100%]' : 'right-0'} items-center bg-[#1E1E1E] lg:scale-[1] z-[999] text-[24px] px-5 lg:px-0 lg:pb-0 pb-4 transition-all duration-300 delay-300 ease-in-out`}>
