...
function AltNav() {
  ...
  return (
    <nav className="flex items-center justify-between px-4 h-[80px]">
      ...
      <div className={`flex flex-col md:flex-row items-center absolute top-[80px] ${displayMobileNav ? 'left-0 scale-[1]' : '-left-[50%] scale-[0]'} md:scale-[1] w-full md:static justify-between md:w-[calc(100%-150px)] bg-[#0E1E1F] z-[999] py-7 md:py-0 transition-all delay-500 ease-in-out`}>
