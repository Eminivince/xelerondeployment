...
export const {displayWalletModal, hideWalletModal, showTransactionSettingsModal, hideTransactionSettingsModal, displayTokenModal, hideTokenModal, displayManageModal, hideManageModal, displaySwapETHforToken, hideSwapETHforToken} = modalSlice.actions
