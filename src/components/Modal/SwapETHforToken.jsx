    ...
    <div>
        ...
        <div className='bg-[#152F30] w-full max-w-[464px] sm:w-[464px] h-[518px] p-4 absolute top-8 left-1/2 -translate-x-1/2 z-50 rounded-lg '>
            <header className='flex items-center mb-[40px]'>
                ...
                <div className='ml-auto cursor-pointer' onClick={() => dispatch(hideSwapETHforToken())}><AiOutlineClose /></div>
            </header>
            ...
            <div className='flex justify-center h-[40px] border-b-[1px] border-[#1B595B] mt-[30px] mb-8'>
                <div className='cursor-pointer relative h-full' onClick={displayDetails}>
                  Details <div className={`${display.details ? 'w-full' : ''} h-[2px] bg-white absolute bottom-0`}></div>
                </div>
                <div className='cursor-pointer relative h-full ml-5' onClick={displayData}>
                  Data <div className={`${display.data ? 'w-full' : ''} h-[2px] bg-white absolute bottom-0`}></div>
                </div>
            </div>
            ...
            <div>
                {
                    ...
                    <div>
                        <div className='flex justify-between mb-7'>
                            <p>Gas fee <span className='text-[#69CED1] text-[12px]'>Edit</span></p>
                            <div>
                                <p>0.000066 ETH</p>
