...
import { hideImportToken } from '../Features/TokenSlice';
    ...
    <div className=''>
        ...
        <div className='bg-[#152F30] w-full max-w-[464px] sm:w-[464px] h-[564px] p-4 absolute top-8 left-1/2 -translate-x-1/2 z-50 rounded-lg flex flex-col'>
            <header className='flex items-center mb-5 justify-between'>
                ...
                <div className=' cursor-pointer' onClick={() => dispatch(hideImportToken())}><AiOutlineClose /></div>
            </header>
            ...
            <div className='h-full mt-8'>
                ...
                <div className='flex items-center justify-center mb-4'>
                    ...
                    <label htmlFor="accept" className='ml-2'>I undertand</label>
                </div>

                <button className='bg-[#69CED1] rounded-[100px] w-full max-w-[384px] block m-auto sm:w-[384px] h-[48px]'>Import</button>
            </div>
